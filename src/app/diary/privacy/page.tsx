...
export default function ToDoooPrivacy() {
  return (
    <>
      ...
      <p>
        We do not collect any personal information from users of ToDooo. All data entered
        into the app is stored locally on your device and is not shared with any third
        parties.
      </p>
      <h2>Data Security</h2>
      <p>
